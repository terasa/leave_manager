...
const Reports: React.FC = () => {
  ...
  const exportToExcel = async () => {
    ...
    // هدر
    const headers1 = ['مرخصی ها نام کارمند', 'کد پرسنلی', 'سمت', 'مرخصی روزانه', 'مرخصی ساعتی', 'کل مرخصی استفاده شده', 'مانده مرخصی', 'تعداد کل'];
    ...
    // هدر
    const headers2 = ['نام', 'کد پرسنلی', 'سمت', 'نوع مرخصی', 'دسته', 'تاریخ شروع', 'تاریخ پایان', 'ساعت شروع', 'ساعت پایان', 'مدت', 'توضیحات'];
